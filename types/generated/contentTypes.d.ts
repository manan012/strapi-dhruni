...
export interface ApiAmenityAmenity extends Schema.CollectionType {
  ...
  attributes: {
    amenity: Attribute.String;
    iconId: Attribute.UID<'api::amenity.amenity', 'amenity'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPropertyCityPropertyCity extends Schema.CollectionType {
